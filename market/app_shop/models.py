...
class Review(models.Model):
    ...
    """
    product = models.ForeignKey("Product", on_delete=models.CASCADE, verbose_name=Product, related_name="review")
...
class ImageProduct(models.Model):
    ...
    url = models.CharField(max_length=255)  # сомневаюсь
...
class Tag(models.Model):
    product = models.ManyToManyField("Product", verbose_name="Tag", related_name="tag")
